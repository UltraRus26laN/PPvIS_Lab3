...
{
    private double mouseX; private double mouseY; private int scale = 0;
    ...
    public ChartGroup()
    {
        ...
        buttonsBox.setLayoutX(40); buttonsBox.setLayoutY(500);
        buttonsBox.setSpacing(20); setChartPressAndDragEvents();
    ...
    public void setChartScroll()
    {
        ...
        {
            if (scrollEvent.getDeltaY() > 0) { higherScale(); }
            if (scrollEvent.getDeltaY() < 0) { lowerScale(); }
        });
    }
    ...
    public void clearChartScroll() { lineChart.setOnScroll(scrollEvent -> {}); }
    public Group getChartGroup() { return graphicGroup; }
    public void updateWordSeriesList(Integer x, Integer y) { arrSeriesData.add(new XYChart.Data<>(x, y)); }
    public void updateNumberSeriesList(Integer x, Integer y) { numberSeriesData.add(new XYChart.Data<>(x, y)); }
